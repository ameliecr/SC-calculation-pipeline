...
echo ""
echo "Co-register the atlas image to the template image to acount for wrong coordinates"
flirt \
    -in $orig_file-reoriented \
    -ref MNI152_T1_3mm_brain \
    -out $orig_file-translated \
...
echo ""
echo "Linearly transform the MNI152 nonlinear template with the 3 mm to the one with the 1 mm resolution"
flirt \
    -in MNI152_T1_3mm_brain \
    -ref $FSLDIR/data/standard/MNI152_T1_1mm_brain \
    -omat 3mm-to-1mm.mat \
    -interp trilinear \
    -cost mutualinfo \
...
echo ""
echo "Warp the atlas image to the MNI152 nonlinear template with 1 mm resolution"
applywarp \
    -i $orig_file-translated \
    -r $FSLDIR/data/standard/MNI152_T1_1mm_brain \
    -o $orig_file-MNI-1mm \
    --interp=nn \
    --premat=3mm-to-1mm.mat
